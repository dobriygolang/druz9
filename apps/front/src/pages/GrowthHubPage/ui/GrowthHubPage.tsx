    ...
    <div className="flex flex-col min-h-screen">
      <div className="px-6 pt-6 pb-0 bg-[#F2F3F0]">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-[#18181b]">Growth</h1>
            <p className="text-sm text-[#64748b] mt-0.5">Готовься к собеседованиям и развивайся</p>
          </div>
        </div>
          ...
          {TABS.map(tab => (
            <Link
              ...
              className={cn(
                ...
                active === tab.id ? 'border-[#FF8400] text-[#18181b]' : 'border-transparent text-[#64748b] hover:text-[#18181b]'
              )}
            >
              {tab.label}
            </Link>
