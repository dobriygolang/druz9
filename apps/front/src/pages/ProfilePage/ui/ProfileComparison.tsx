...
export function ProfileComparison({
  ...
  return (
    <div className={`section-enter flex flex-col gap-3 rounded-[20px] border border-[#d8d9d6] bg-white px-4 py-3 shadow-[0_12px_26px_rgba(15,23,42,0.06)] dark:border-[#163028] dark:bg-[#132420] md:flex-row md:items-center md:justify-between ${className ?? ''}`}>
      <div className="flex flex-col gap-1 text-sm text-[#4B6B52] dark:text-[#7BA88A]">
        <p>
          <span className="font-semibold text-[#111111] dark:text-[#E2F0E8]">{t('profile.comparison.rating')}</span>{' '}
        ...
        <p>
          <span className="font-semibold text-[#111111] dark:text-[#E2F0E8]">{t('profile.comparison.streak')}</span>{' '}
      ...
      <button
        onClick={onChallenge}
        className="inline-flex items-center justify-center rounded-full bg-[#111111] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#0B1210] dark:bg-white dark:text-[#08101f] dark:hover:bg-[#e2e8f3]"
      >
