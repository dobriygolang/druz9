...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#E7E8E5] border-t border-[#CBCCC9] flex items-stretch md:hidden"
      ...
      {NAV_ITEMS.map((item) => {
        ...
        return (
          ...
          >
            ...
            {active && (
              <span className="absolute top-0 inset-x-0 h-[2px] bg-[#6366F1] rounded-b-full" />
            )}
          </Link>
        )
      })}
