  ...
  return (
    <Modal open={open} onClose={onClose} title={t('arena.info.title')} subtitle={t('arena.info.subtitle')} size="md">
      <div className="flex flex-col gap-6">
        {/* Rating */}
        <section>
          <h3 className="flex items-center gap-2 text-sm font-bold text-[#111111] dark:text-[#E2F0E8]">
          ...
          <p className="mt-2 text-xs leading-5 text-[#4B6B52] dark:text-[#94a3b8]">{t('arena.info.rating.desc')}</p>
          <ul className="mt-2 flex flex-col gap-1 text-xs text-[#4B6B52] dark:text-[#94a3b8]">
            ...
            <li className="flex items-start gap-1.5">
              <span className="mt-0.5 h-1 w-1 flex-shrink-0 rounded-full bg-[#059669]" />
        ...
        <section>
          <h3 className="flex items-center gap-2 text-sm font-bold text-[#111111] dark:text-[#E2F0E8]">
            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-[#ecfdf5] text-xs dark:bg-[#1e2a4a]">
              <span className="text-[#059669]">&#127942;</span>
            </span>
            {t('arena.info.leagues.title')}
          </h3>
          <p className="mt-2 text-xs text-[#4B6B52] dark:text-[#94a3b8]">{t('arena.info.leagues.desc')}</p>
          <div className="mt-3 overflow-hidden rounded-xl border border-[#E4EBE5] dark:border-[#1E4035]">
            {LEAGUES.map((l, i) => (
              <div
                key={l.key}
                className={`flex items-center justify-between px-3 py-2 text-xs ${i > 0 ? 'border-t border-[#F2F3F0] dark:border-[#1E4035]' : ''}`}
              >
                <div className="flex items-center gap-2">
                  <span className="h-2 w-2 rounded-full" style={{ backgroundColor: l.color }} />
                  <span className="font-medium text-[#111111] dark:text-[#E2F0E8]">
        ...
        <section>
          ...
          <p className="mt-2 text-xs leading-5 text-[#4B6B52] dark:text-[#94a3b8]">{t('arena.info.seasons.desc')}</p>
          <ul className="mt-2 flex flex-col gap-1 text-xs text-[#4B6B52] dark:text-[#94a3b8]">
            <li className="flex items-start gap-1.5">
        ...
        <section>
          <h3 className="flex items-center gap-2 text-sm font-bold text-[#111111] dark:text-[#E2F0E8]">
            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-[#ecfdf5] text-xs dark:bg-[#2a2006]">
              <span className="text-[#f59e0b]">&#10024;</span>
            </span>
            {t('arena.info.rewards.title')}
          </h3>
          <ul className="mt-2 flex flex-col gap-1.5 text-xs text-[#4B6B52] dark:text-[#94a3b8]">
            <li className="flex items-start gap-1.5">
