...
// GuildWarNotifyDeps groups optional fan-out dependencies. When all are non-nil
...
type GuildWarNotifyDeps struct {
...
func StartGuildWarCron(warRepo *guilddata.Repo, notify GuildWarNotifyDeps) func() error {
...
func runGuildWarTick(ctx context.Context, warRepo *guilddata.Repo, notify GuildWarNotifyDeps, now time.Time) {
	switch now.Weekday() {
	case time.Monday:
...
func runPhaseTransition(ctx context.Context, warRepo *guilddata.Repo, notify GuildWarNotifyDeps, from, to string) {
...
func runSundayResolution(ctx context.Context, warRepo *guilddata.Repo, notify GuildWarNotifyDeps) {
...
func fanOutPhaseTransition(ctx context.Context, warRepo *guilddata.Repo, notify GuildWarNotifyDeps, phase string) {
...
func fanOutSummary(ctx context.Context, warRepo *guilddata.Repo, notify GuildWarNotifyDeps, wars []guilddata.WarSummary, kind, title string) {
	for _, w := range wars {
