...
func (i *Implementation) UnsavePodcast(ctx context.Context, req *v1.UnsavePodcastRequest) (*v1.PodcastStatusResponse, error) {
	...
	if err := i.saved.UnsavePodcast(ctx, user.ID, id); err != nil {
		return nil, kratoserrors.InternalServer("INTERNAL", "failed to unsave podcast")
	}
